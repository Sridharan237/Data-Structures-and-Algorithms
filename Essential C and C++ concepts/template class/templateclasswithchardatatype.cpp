...
int main()
{
    Arithmetic<char> ar('A','B');               //  <parameter(or)argument> ------> template argument - argument passed to template class
    
    cout<<"Object 1 : "<<endl;
    cout<<"Add : "<<int(ar.add())<<endl;              // typecast-we can typecast like this int(variable/datamember) also     (or)
    cout<<"Subtract : "<<(int)ar.sub()<<endl;         // typecast-we can typecast like this (int)variable/datamember also
