    ...
    scanf("%d",&option);
     ...
     switch(option)
     {
        ...
        case 2:
            ...
            scanf("%d",&index);
            deletedElement=Delete(&arr,index);
            printf("Deleted element is : %d\n",deletedElement);
            break;
        case 3:
            printf("Enter the element to be searched : ");
            scanf("%d",&SearchingElement);
            searchedElement_index=LinearSearch(&arr,SearchingElement);
            printf("The index of the searched element is : %d",searchedElement_index);
            break;
        case 4:
            sum=Sum(arr);
