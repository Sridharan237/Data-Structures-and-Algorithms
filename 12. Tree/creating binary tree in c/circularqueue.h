// c program to create, display and perform various operations on a Circular Queue using array to store address (datatype : struct Node* - circular queue)
#include<stdio.h>
#include<stdlib.h>
...
void enqueue(struct CircularQueue *cq, struct Node *x)
{
...
struct Node* dequeue(struct CircularQueue *cq)
{
    struct Node *x = 0;
