//C program to maximum element in linked list recursively
#include<stdio.h>
#include<stdlib.h>
#include<limits.h>
...
int Rmax(struct Node * p)
{
    ...
    if(p == 0)
        return INT_MIN;   //64 bit minimum integer 
    //To use INT_MIN keyword, we need to include limits.h

    x = Rmax(p->next);

    return x>p->data?x:p->data; //Ternary operator (or) conditional operator
}
